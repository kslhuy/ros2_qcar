...
class Follower:
    def __init__(self, qcar, idm_controller, vehicle_id=1, max_steering=0.6):
        ...
        self.leader_state = {'seq': -1, 'pos': [0, 0, 0], 'rot': [0, 0, 0], 'v': 0.5}
        self.last_seq = -1
    ...
    def listen_for_leader(self):
        while True:
            ...
            # if seq != self.last_seq + 1 and self.last_seq != -1:
            #     missed = seq - self.last_seq - 1
            #     print(f"Missed {missed} packet(s) — last seq: {self.last_seq}, current: {seq}")
    ...
    def follow(self):
        ...
        try:
            ...
            print("QLabs timeout or error:", e)
