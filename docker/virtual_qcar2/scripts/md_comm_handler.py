...
class CommHandler:
    ...
    def __init__(self, vehicle_id: int, target_ip: str, send_port: int, recv_port: int, ack_port: int, logger: logging.LoggerAdapter):
        ...
        self.ack_sock.settimeout(0.5)  # Increased from 0.2 to 0.5 seconds
        self.ack_sock.bind(('0.0.0.0', self.ack_port))
        self.logger.info(f"Bound ack_sock to port {self.ack_port}")  # Debug binding
